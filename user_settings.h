...
typedef struct
{
	...
	char* m_parsed_output_filename_2;			/*!< The name for parsed data output data file */
	char* m_raw_output_filename;			/*!< The name for raw output data file */
	char* m_raw_output_filename_2;			/*!< The name for raw output data file */
	UINT16 m_base_address;					/*!< The board base address */
	UINT16 m_base_address_2;					/*!< The board base address */

...
#define DEF_RAW_OUTPUT_FILENAME_2		       	"raw_values_2.dat"						/*!< Raw board values default filename */
#define DEF_PARSED_OUTPUT_FILENAME			"parsed_values.dat"						/*!< Parsed board values default filename */
#define DEF_PARSED_OUTPUT_FILENAME_2			"parsed_values_2.dat"						/*!< Parsed board values default filename */

#define MAX_FILENAME_LENGHT					255										/*!< Maximum filenam length */

#define DEF_NUM_EVENTS						-1										/*!< Default number of events */
#define DEF_BASE_ADDRESS					0xee00									/*!< Default boards' base address */
#define DEF_BASE_ADDRESS_2					0x1111									/*!< Default boards' base address */
...
BOOL user_settings_open( user_setting_data* p_data)
{
	...
	p_data->m_raw_output_filename_2= (char*)malloc( MAX_FILENAME_LENGHT);
	p_data->m_parsed_output_filename= (char*)malloc( MAX_FILENAME_LENGHT);
	p_data->m_parsed_output_filename_2= (char*)malloc( MAX_FILENAME_LENGHT);
	...
	if( p_data->m_raw_output_filename_2== NULL)
		TRACE("user setting module: insufficient memory !\n");
	else
		strcpy( p_data->m_raw_output_filename_2, DEF_RAW_OUTPUT_FILENAME_2);
	...
	if( p_data->m_parsed_output_filename_2== NULL)
		TRACE("user setting module: insufficient memory !\n");
	else
		strcpy( p_data->m_parsed_output_filename_2, DEF_PARSED_OUTPUT_FILENAME_2);

	p_data->m_num_events= DEF_NUM_EVENTS;
	p_data->m_base_address= DEF_BASE_ADDRESS;
	p_data->m_base_address_2= DEF_BASE_ADDRESS_2;
